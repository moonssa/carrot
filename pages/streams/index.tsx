...
const Live: NextPage = () => {
  return (
    <div className="py-10  divide-y-2 space-y-4">
      ...
      <button className="fixed hover:bg-orange-500  transition-colors cursor-pointer bottom-24 right-5 shadow-xl bg-orange-400 rounded-full p-3 border-transparent text-white">
        <svg
          className="w-6 h-6"
          fill="none"
          strokeWidth="1.5"
